...
#define MIC_LEVEL_PACKET_INIT_DEFAULT            {0, 0, 0, 0, 0, _MIC_WEIGHTING_MIN, {{NULL}, NULL}}
...
#define MIC_LEVEL_PACKET_INIT_ZERO               {0, 0, 0, 0, 0, _MIC_WEIGHTING_MIN, {{NULL}, NULL}}
...
X(a, CALLBACK, REPEATED, MESSAGE,  payload,           7)
#define MIC_LEVEL_PACKET_CALLBACK pb_default_field_callback
...
/* MicLevelPacket_size depends on runtime parameters */
