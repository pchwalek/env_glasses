...
typedef struct mic_level_packet {
    ...
    uint32_t sample_length; /* e.g., 8192 samples */
    uint32_t num_of_samples_used; /* e.g., if multiple sample windows are averaged */
...
#define MIC_LEVEL_PACKET_INIT_DEFAULT            {0, 0, 0, 0, 0, _MIC_WEIGHTING_MIN, 0, {MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT, MIC_LEVEL_PACKET_PAYLOAD_INIT_DEFAULT}}
...
#define RED_FLASH_TASK_INIT_DEFAULT              {0, 0, 0, 0, 0, 0, 0}
...
#define MIC_LEVEL_PACKET_INIT_ZERO               {0, 0, 0, 0, 0, _MIC_WEIGHTING_MIN, 0, {MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO, MIC_LEVEL_PACKET_PAYLOAD_INIT_ZERO}}
...
#define RED_FLASH_TASK_INIT_ZERO                 {0, 0, 0, 0, 0, 0, 0}
...
#define RED_FLASH_TASK_ENABLE_LIGHT_TAG          7
...
#define AIR_SPEC_CONFIG_PACKET_RTC_PACKET_TAG    9
...
X(a, STATIC,   SINGULAR, UINT32,   enable_light,      7)
...
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,rtc_packet,payload.rtc_packet),   9)
...
#define air_spec_config_packet_t_payload_rtc_packet_MSGTYPE rtc_packet_t
...
#define MIC_LEVEL_PACKET_SIZE                    1482
